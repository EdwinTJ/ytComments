...
from database.database import Base, engine  # Import Base and engine from your database setup
from database.database import DATABASE_URL  # Ensure your database URL is available
